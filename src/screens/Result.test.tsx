...
describe("Result", () => {
  ...
  it("restores the latest captured frame after a refresh", () => {
    sessionStorage.setItem(
      "deep-spec:latest-captured-frame",
      JSON.stringify({
        imageBase64: "data:image/jpeg;base64,restored-image",
        capturedAt: "2026-05-16T00:00:00.000Z",
      }),
    );
    ...
    expect(screen.getByRole("img", { name: "Captured car part" })).toHaveAttribute(
      "src",
      "data:image/jpeg;base64,restored-image",
    );
  });
