...
export default function MotionPermissionModal({ error, onAllow }: MotionPermissionModalProps) {
  return (
    <div className="fixed inset-0 z-30 grid place-items-center bg-black/72 px-5 backdrop-blur-md">
      <div className="w-full max-w-sm rounded-[28px] border border-white/10 bg-slate-950 p-6 text-center shadow-2xl">
        <div className="mx-auto mb-5 grid size-14 place-items-center rounded-2xl bg-[var(--ds-accent-soft)] text-2xl text-[var(--ds-accent)]">
          DS
        </div>
