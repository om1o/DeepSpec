...
async function writeGroupFixture({ labels, rawDir, rawName, secondaryTitle, title }) {
  ...
  await writeFile(
    ...
    JSON.stringify({
      objects: [
        { classTitle: title, points: { exterior: [[0, 0], [10, 0], [10, 10], [0, 10]] } },
        ...(secondaryTitle ? [{ classTitle: secondaryTitle, points: { exterior: [[0, 0], [2, 0], [2, 2], [0, 2]] } }] : []),
      ],
    }),
  );
