...
| Published application CI | [Run 36255542250](https://github.com/om1o/DeepSpec/actions/runs/36255542250), head `8dce4d989be5badcb71e21f13a927be7d36e96e1`: lint, 1,015 tests and build succeeded. Auth failed because the two Supabase settings were unavailable; cloud check skipped. | Blocked: settings and a successful run on the final review head. |
| Browser/local recovery tests | [Draft recovery report](DRAFT_RECOVERY_RELEASE_REPORT_2026-09-26.md) records 1,015 tests and mobile/desktop close/reopen, explicit restore/discard, storage failure, device save/reload/export and stale-edit checks. Cloud inspection failures were intercepted. | Device recovery verified; live inspection-cloud persistence remains unverified. |
