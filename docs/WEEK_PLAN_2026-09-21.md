...
| Implemented in repository | Explicit unresolved identity with reasons on scanner, saved details and reports; unresolved filter in history. See [build log](BUILD_LOG_2026-09-20.md). | Photo-quality rejection still needs preserved evidence and the guided retake limit is pending. |
| Planned this week | One guided retake and preservation of rejected quality-check photos. | Not a shipped unattended intake system; keep manual approval during the pilot. |
