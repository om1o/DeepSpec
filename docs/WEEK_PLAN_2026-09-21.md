...
Later verification: two generated QA accounts passed owner read/write and cross-account read isolation for the exercised scan/detail tables and private images. See [the continuing build log](BUILD_LOG_2026-09-20.md). Organization permissions, browser-local account switching and inspection-cloud persistence remain separate unverified gates.
