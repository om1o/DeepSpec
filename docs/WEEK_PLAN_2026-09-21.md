...
| Planned this week | Minimal intake draft with evidence status, one guided retake, and a visible exception state. | Not a shipped unattended intake system; keep manual approval during the pilot. |
