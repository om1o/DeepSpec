...
- The live GitHub release stack is down to one open draft PR: #79, `[codex] Production readiness release v44 evidence and safety state`.
...
- Supabase Preview check on PR #79 passed.
...
| P0-004 | Blocker | Release quality | The active release PR is still draft. | PR #79 is the only open release PR and remains draft. | Keep review honest, keep superseded PRs closed, and make PR #79 ready only after cloud gates pass. |
