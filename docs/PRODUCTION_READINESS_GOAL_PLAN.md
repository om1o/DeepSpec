...
- The live GitHub release stack is down to one open draft PR: #81, `[codex] Production readiness release v46 result tabs evidence`.
...
- Supabase Preview check on PR #81 passed.
...
| P0-004 | Blocker | Release quality | The active release PR is still draft. | PR #81 is the only open release PR and remains draft. | Keep review honest, keep superseded PRs closed, and make PR #81 ready only after cloud gates pass. |
