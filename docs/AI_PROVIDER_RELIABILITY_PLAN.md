...
6. Eval summaries must include launch metrics: accuracy, invalid response rate, provider failure rate, retry count/rate, latency distribution, and rule-derived safety false positives/false negatives.
