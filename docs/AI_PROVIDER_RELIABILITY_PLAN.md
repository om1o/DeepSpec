...
6. Eval summaries must include launch metrics: accuracy, invalid response rate, provider failure rate, retry count/rate, latency distribution, OCR usage count/rate, and rule-derived safety false positives/false negatives.
